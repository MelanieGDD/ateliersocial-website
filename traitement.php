...
// Configuration pour l'envoi des emails (à adapter)
...
// Envoi d'un email de confirmation à l'utilisateur (à adapter)
$to_user = $email;
...
// Message de confirmation à afficher sur la page (à personnaliser)
